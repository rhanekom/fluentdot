...
namespace FluentDot.Tests.Conventions
{
    ...
    public class ConventionTrackerTests
    {
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new ConventionTracker().AddConvention((INodeConvention) null));
        }

        [Test]
        public void AddConvention_Edge_Should_Throw_Exception_If_Convention_Is_Null()
        {
            Assert.Throws<ArgumentNullException>(() => new ConventionTracker().AddConvention((IEdgeConvention)null));
        }
        ...
        //    var convention = new Mock<INodeConvention>();
        //    convention.Setup(x => x.ShouldApply(nodeInfo))
        ...
        //{
        //    var conventionTracker = new ConventionTracker();
        //    var convention = new Mock<IEdgeConvention>();
